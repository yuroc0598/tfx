  ...
  def __init__(self,
    ...
    Args:
      ...
      enable_cache: Optional boolean to indicate if cache is enabled for the
        QueryBasedExampleGen component. If not specified, it will follow the
        pipeline's enable_cache.
    """
    # Configure outputs.
...
class FileBasedExampleGen(base_component.BaseComponent):
  ...
  def __init__(
    ...
    Args:
      ...
      enable_cache: Optional boolean to indicate if cache is enabled for the
        FileBasedExampleGen component. If not specified, it will follow the
        pipeline's enable_cache.
    """
    if input_base:
